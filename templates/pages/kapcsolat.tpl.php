            ...
            <form action = "?oldal=uzenetkuldes" id="kapcsolatform" method = "post">
                <fieldset>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea  name="uzenet" class="form-control" id="uzenet" required laceholder="Ide írd az üzenetet, amit el szeretnél küldeni..."> </textarea>
                    </div>
                    <div class="mb-3">
                        <input class="btn" type="submit" name="kuldes" value="Küldés">
                    </div>
                </fieldset>
            </form>
        </div>
    <?php } ?>
        <div class="<?php if(isset($_SESSION['login'])) { ?>
            <?= "col-md-6" ?>
        <?php } else { ?>
            <?= "col-md-12" ?>
        <?php } ?>
